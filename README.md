...
* ```csv files```: Five (5) *csv data files will be created, namely:
  * A file with all the MODVOLC thermal anomalies detected for the site of inetrest including: date, longitude, latitude and spectral radiance at 4$\mu$m, \beta, $\beta$
##
