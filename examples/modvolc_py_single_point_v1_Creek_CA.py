...
https://github.com/saballos/modvolc_py_sp.git
"""
#===================================================================#
#                          INPUT PARAMETERS                         #
#===================================================================#
...
name = "Creek fire" # name in double-quotes #

# Initial date to look for the thermal anomalies: ti (YYYY-MM-DD) #
ti = "2020-01-01" # Start date to look for MODVOLC thermal anomalies in double-quotes #

# Final date to look for the thermal anomalies: tf (YYYY-MM-DD) #
tf = "2022-01-01" # Final date to look for MODVOLC thermal anomalies in double-quotes #

# Geographic WGS84 coordinates of the site of interest: lon E (ddg), lat N (ddg) #
lon = -119.261175 # e.g. lon = -90.88063 # East longitude in decimal degrees
lat = 37.19147 # e.g. lat = 14.47409 # North latitude in decimal degrees

# Search Radius for thermal anomalies around the site of interest in (km) #
rad = 20 # Radius of search in km
