...
name = "Mount Etna" # name in double-quotes #

# Initial date to look for the thermal anomalies: ti (YYYY-MM-DD) #
ti = "2021-01-01" # Start date to look for MODVOLC thermal anomalies in double-quotes #
...
lon = 14.993047 # e.g. lon = -90.88063 # East longitude in decimal degrees
lat = 37.750772 # e.g. lat = 14.47409 # North latitude in decimal degrees

# Search Radius for thermal anomalies around the site of interest in (km) #
rad = 3.8 # Radius of search in km
