...
Note: the earliest data from the MODVOLC algorithm is from Feb 2000,
but it doesn't mean that a thermal anomaly was necessary detected in
that month for your area of interest. Thus, if you want to try to see
the oldest MODVOLC anomalies for any site, you shuold set your intial
date as this: ti = "2000-02-01"
"""
#===================================================================#
#                          INPUT PARAMETERS                         #
#===================================================================#
